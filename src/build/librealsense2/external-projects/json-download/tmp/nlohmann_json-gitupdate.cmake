...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/imr/jauremax_ros2/src/build/librealsense2/third-party/json'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/imr/jauremax_ros2/src/build/librealsense2/third-party/json'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
